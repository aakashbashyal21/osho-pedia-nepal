...
async function BlogCardContainer() {
    ...
    return (
        <main className="grid flex-1 items-start gap-4 px-4 py-12 mx-auto max-w-screen-xl sm:px-2 sm:py-0 md:gap-8 lg:px-8">
            <div className="grid max-w-[70rem] flex-1 auto-rows-max gap-6 px-4 py-4 sm:px-4 lg:gap-8">
