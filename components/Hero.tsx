        ...
        <section className="dark:bg-gray-900 pt-16 px-8">
            <div className="grid max-w-screen-xl py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
                <div className="mr-auto place-self-center lg:col-span-7">
                    <h1 className="max-w-2xl mb-4 text-4xl font-extrabold tracking-tight leading-normal  md:text-5xl xl:text-6xl dark:text-white">{siteConfig.heroSectionTitle}</h1>
